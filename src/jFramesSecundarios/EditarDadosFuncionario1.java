...
public class EditarDadosFuncionario1 extends javax.swing.JFrame {
    ///chave primaria do cliente que esta sendo editado   

    private Long idCliente;

    public EditarDadosFuncionario1(Long idCliente) {
...
public class EditarDadosFuncionario1 extends javax.swing.JFrame {
     ...
     */
    public EditarDadosFuncionario1() {
        initComponents();
         Util.centralizar(this);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarDadosFuncionario1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarDadosFuncionario1().setVisible(true);
            }
        });
    }
